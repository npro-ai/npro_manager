/* Copyright (C) 2015, npro_service Inc.
...
static LPTSTR g_lpszServiceName        = "NproSvc";
static LPTSTR g_lpszServiceDisplayName = "npro_service";
static LPTSTR g_lpszServiceDescription = "npro_service Windows Agent";
    ...
    if (ossecServiceStatusHandle) {
        switch (dwOpcode) {
            case SERVICE_CONTROL_STOP:
                ...
                // Kill children processes spawned by modules, only in npro-agent
                wm_kill_children();
                stop_wmodules();
